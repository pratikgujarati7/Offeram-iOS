//
//  PaymentSucceedViewController.m
//  Offeram
//
...
@interface PaymentSucceedViewController ()
{
...
@implementation PaymentSucceedViewController
...
- (void)setupInitialView
{
    ...
    btnProceed.titleLabel.font = btnTitleFont;
